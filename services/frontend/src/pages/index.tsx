...
const Home: React.FC = () => {
	const todos = trpc.todos.list.useQuery({ id: '123' })
			...
			<div className="mb-20">
				...
				<button
					...
					onClick={async (): Promise<void> => {
						const resp = await createTodo.mutateAsync({
							name: window.prompt('What name?') ?? 'karel'
						})
