	...
	new NextjsSite(stack, 'Next', {
		...
		customDomain: {
			...
			hostedZone: isProd(app)
				? 'purple-technology.io'
				: 'staging.purple-technology.io',
			cdk: {
				certificate: Certificate.fromCertificateArn(
					stack,
					'certificate',
					isProd(app) ? 'some-arn-here' : 'some-arn-here'
				)
			}
		}
	})
